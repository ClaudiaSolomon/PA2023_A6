...
public class GameServer {
    ...
    public static void setPlayersTo0() {
        GameServer.nrOfPlayers = 0;
    }
...
//    ClientThread.communicate();
        ...
        try {
            ...
            while (running) {
                ...
                if (nrOfPlayers < 2) new ClientThread(socket).start();
                sleep(5000);
            }
        } catch (IOException e) {
...
//    nrOfPlayers++;
        if (GameServer.nrOfPlayers % 2 == 0 && GameServer.nrOfPlayers != 0) {
            player0 = new Player(nrOfPlayers, 120000); //120 secunde
            //timer on
            startGame = true;
            ...
            playerX = new Player(nrOfPlayers - 1, 120000);
//        Player.startTimer();
